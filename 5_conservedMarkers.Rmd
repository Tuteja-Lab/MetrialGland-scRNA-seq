...
<<<<<<< HEAD
#to get genes in each cell types after PlacentaCellEnrich: evt1 <- humanOrthologs[humanOrthologs$Human.gene.stable.ID %in% assay(output2[[2]]$EVT)[,1] , "Gene.name"]
...
>>>>>>> faba99782833739579cf0fdb22cf28ed33f8cbac
```
